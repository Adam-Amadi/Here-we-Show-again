...
while (counter <= 20) {
  ...
  parentElement.append (kata1Heading)
  kata1Heading.append ('KATA1:' + counter)
  counter ++
}
/** KATA 02 ⮕
***
...
while (evenCounter <= 20) {
  ...
  parentElement.append (kata1Heading)
  kata1Heading.append ('KATA2:' + evenCounter)
  evenCounter += 2
}
...
while (oddCounter <= 20) {
  ...
  const kata1Heading = document.createElement ('div')
  parentElement.append (kata1Heading)
  kata1Heading.append ('KATA3:' + oddCounter)
  oddCounter += 2
}
...
while (fiveCounter <= 100) {
  ...
  const kata1Heading = document.createElement ('div')
  parentElement.append (kata1Heading)
  kata1Heading.append ('KATA4:' + fiveCounter)
  fiveCounter += 5
}
...
let squareCounter = 1
  while (squareCounter <= 100) {
      ...
      if (perfectSquare) {
        ...
        const kata1Heading = document.createElement ('div')
        parentElement.append (kata1Heading)
        kata1Heading.append ('KATA5:' + squareCounter)
      }
    squareCounter += 1
  }
...
while (backCounter >= 1) {
  ...
  const kata1Heading = document.createElement ('div')
  parentElement.append (kata1Heading)
  kata1Heading.append ('KATA6:' + backCounter)
  backCounter -= 1
}
...
while (evenBackcount >= 2) {
  ...
  const kata1Heading = document.createElement ('div')
  parentElement.append (kata1Heading)
  kata1Heading.append ('KATA7:' + evenBackcount)
  evenBackcount -= 2
}
...
while (oddBackcount >= 1) {
  ...
  const kata1Heading = document.createElement ('div')
  parentElement.append (kata1Heading)
  kata1Heading.append ('KATA8:' + oddBackcount)
  oddBackcount -= 2
}
...
while (fiveBackcount >= 5) {
  ...
  const kata1Heading = document.createElement ('div')
  parentElement.append (kata1Heading)
  kata1Heading.append ('KATA9:' + fiveBackcount)
  fiveBackcount -= 5
}
...
while (squareBackcount >= 1) {
  ...
  if (intSquareBackCount) {
    ...
    const kata1Heading = document.createElement ('div')
    parentElement.append (kata1Heading)
    kata1Heading.append ('KATA10:' + squareBackcount) 
  }
  squareBackcount -= 1
}
...
const kata1Heading = document.createElement ('div')
    parentElement.append (kata1Heading);
    kata1Heading.append ('KATA 15:' + variable);
...
const smallNum=Math.min(...sampleArray)
    const kata17Heading = document.createElement ('div')
    parentElement.append (kata17Heading);
    kata17Heading.append ('KATA 17:' + smallNum)
...
const largeNum=Math.max(...sampleArray)
    const kata18Heading = document.createElement ('div')
    parentElement.append (kata18Heading);
    kata18Heading.append ('KATA 18:' + largeNum)